...
\begin{figure}[hbt]
  \centering
	\scalebox{0.7}{\input{figures/profundidad}}
...
\begin{figure}[hbt]
  \centering
	\scalebox{0.7}{\input{figures/generic_tree}}
...
\begin{figure}[hbt]
  \centering
	\scalebox{0.48}{\input{figures/sol_y_sombra/bi_anchura}}
...
\begin{figure}[hbt]
  \centering
	\scalebox{0.55}{\input{figures/sol_y_sombra/profundidad}}
